...
Robot decyduje jaka akcja zostanie wykonana na podstawie istniejącej polisy. Polisa jest to 

Dział uczenia maszynowego
● Brak przykładów trenujących
● Nauka na przez interakcję z otoczeniem
● Metoda prób i błędów
● Natychmiastowa nagroda (akcję wpływają
na otrzymaną nagrodę)
● Opóźniona nagroda (akcję wpływają
również na następne sytuacje przez to
na kolejne nagrody)

Podstawową funkcjonalnością aplikacji, jest implementacja inteligentnego agenta, który
mając wiedzę na temat:
➢ akcji, które może wykonać,
➢ stanu w jakim się znajduje,
➢ zasad, które definiują co agent obserwuje,
...
najlepszy wynik w kolejnych iteracjach symulacji.
